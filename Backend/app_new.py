...
#     # Default to Tamil if not specified
...
#         # Explicitly translate to Tamil
#         translated_text = translate_fn('ta', transcript)
#         print("Translated Transcript (Tamil):", translated_text)
...
#         # Convert translated text to speech in Tamil
